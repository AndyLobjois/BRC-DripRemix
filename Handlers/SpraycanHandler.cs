...
namespace DripRemix {
    ...
    public class SpraycanHandler {
        ...
        public SpraycanHandler() {
            //indexMeshConfig = Main.Instance?.Config.Bind<int>("Save Index", $"{WorldHandler.instance.currentPlayer.character}_SPRAYCAN_Mesh_Index", 0);
            //indexTextureConfig = Main.Instance?.Config.Bind<int>("Save Index", $"{WorldHandler.instance.currentPlayer.character}_SPRAYCAN_Texture_Index", 0);
        }
        ...
        public void GetAssets() {
            ...
            // Search & Add
            DirectoryInfo[] folders = Main.SpraycansFolder.GetDirectories();
