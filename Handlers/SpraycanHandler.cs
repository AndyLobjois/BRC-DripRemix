...
namespace DripRemix {
    ...
    public class SpraycanHandler {
        ...
        public SpraycanHandler() {
            //indexMeshConfig = Main.Instance.Config.Bind<int>("General", $"Spraycan_IndexMesh", 0);
            //indexTextureConfig = Main.Instance.Config.Bind<int>("General", $"Spraycan_IndexTexture", 0);
        }
